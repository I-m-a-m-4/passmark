      ...
      <div className="w-full max-w-md relative z-10 mt-20 mb-20">
        ...
        <AuraCard className="overflow-hidden relative">
          ...
          <div className="p-8 space-y-6">
            ...
            <Button variant="outline" type="button" className="w-full border-border bg-secondary/50 hover:bg-emerald-500 hover:text-white h-12 rounded-xl transition-all flex items-center justify-center gap-3" onClick={handleGoogleLogin}>
