    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-3 text-center py-24 bg-black/[0.02] dark:bg-white/[0.02] rounded-[2rem] border border-dashed border-black/10 dark:border-white/10">
                    <SearchIcon className="h-12 w-12 text-zinc-300 dark:text-gray-700 mx-auto mb-4" />
                    <h3 className="font-bold text-xl mb-2 text-zinc-400 dark:text-gray-400 italic font-headline">Awaiting search signal...</h3>
                    <p className="text-zinc-500 dark:text-gray-500 text-sm">Enter a course code or topic above to explore the network.</p>
                </div>
            </div>

            <AuraCard className="dark:bg-[#030303] p-12 text-center max-w-3xl mx-auto shadow-2xl">
                <Sparkles className="h-12 w-12 text-emerald-500 mx-auto mb-6 animate-pulse" />
                <h2 className="text-2xl font-bold mb-4 text-zinc-900 dark:text-white font-headline">Smart indexing in progress...</h2>
