...
export default function LandingPage() {
  ...
  return (
    <div
      className="selection:bg-emerald-500/30 selection:text-white antialiased overflow-x-hidden text-white font-sans bg-[#030303] min-h-screen"
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="fixed inset-y-0 left-1/2 -translate-x-1/2 w-full max-w-7xl border-x border-white/10 pointer-events-none z-0 flex justify-evenly">
        ...
        <div
          className="absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2 w-1.5 h-1.5 bg-[#030303]"
          style={{ border: "1px solid rgba(255,255,255,0.2)" }}
        ></div>
        <div
          className="absolute top-0 right-0 translate-x-1/2 -translate-y-1/2 w-1.5 h-1.5 bg-[#030303]"
          style={{ border: "1px solid rgba(255,255,255,0.2)" }}
        ></div>
        <div
          className="absolute bottom-0 left-0 -translate-x-1/2 translate-y-1/2 w-1.5 h-1.5 bg-[#030303]"
          style={{ border: "1px solid rgba(255,255,255,0.2)" }}
        ></div>
        <div
          className="absolute bottom-0 right-0 translate-x-1/2 translate-y-1/2 w-1.5 h-1.5 bg-[#030303]"
          style={{ border: "1px solid rgba(255,255,255,0.2)" }}
        ></div>
      </div>
          ...
          {["Archive", "Library", "Guides"].map((item) => (
            <li key={item}>
              <a
                ...
                className="block rounded-full px-4 py-1.5 transition-colors duration-300 hover:text-white hover:bg-white/5"
              >
                {item}
              </a>
            </li>
      ...
      <main className="z-10 flex flex-col w-full relative items-center">
        ...
        <section className="min-h-screen flex flex-col w-full max-w-7xl border-white/10 border-t border-b mr-auto ml-auto pt-40 pb-12 relative items-center justify-center">
          <div
            ...
            style={{
              maskImage:
                "linear-gradient(transparent 10%, black 50%, black 90%, transparent 100%)",
            }}
          ></div>
          ...
          <div className="relative z-20 flex w-full max-w-4xl flex-col items-center mx-auto mt-12 py-12 px-6">
            ...
            <h1 className="mb-6 text-center text-5xl font-light leading-[1.1] tracking-tighter drop-shadow-2xl md:text-7xl lg:text-8xl">
              <span className="inline-block overflow-hidden pb-2">
                <span className="reveal-word font-medium text-transparent bg-clip-text bg-gradient-to-br from-white to-gray-500">
                  Academic
                </span>
              </span>
              ...
              <span className="inline-block overflow-hidden pb-2">
                <span
                  className="reveal-word text-white"
            ...
            <p className="mb-10 max-w-2xl text-center text-base leading-relaxed text-gray-400 md:text-xl text-balance">
              Verified exam papers organized into smart study libraries.
              Naturally grasp core concepts and boost your grades with ease.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-center">
              ...
              >
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle at var(--x) var(--y), rgba(16, 185, 129, 0.4) 0%, transparent 60%)",
                  }}
                ></div>
        ...
        <section className="relative z-10 py-64 px-6 bg-[#030303] border-y border-white/5">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-6xl font-medium leading-[1.2] text-neutral-800 tracking-tight">
              {"Stop manually searching for blurry exam photos. PassMark organizes everything, converting complex study materials into easy study sessions for your success."
                .split(" ")
                .map((word, i) => (
                  <span
                    key={i}
                    className="transition-all duration-700 hover:text-white inline-block mr-3 cursor-pointer"
                  >
                    {word}
                  </span>
                ))}
                ...
                <div className="relative z-10 max-w-5xl">
                  ...
                  <h2 className="text-5xl md:text-7xl lg:text-[6rem] text-white leading-[0.85] mb-8 font-light tracking-tight split-text-down">
                    {"P A S S M A R K".split(" ").map((char, i) => (
                      <span
                        key={i}
                        className="char-wrap inline-block overflow-hidden align-bottom"
                      >
                        <span
                  ...
                  <p className="text-gray-400 max-w-xl leading-relaxed text-lg italic">
                    Our platform uses advanced AI to simplify your study
                    routine. Every document is checked for accuracy to ensure
                    you have the best study materials available.
                  </p>
                </div>
              </div>
                ...
                <div className="lg:col-span-4 border-b lg:border-b-0 lg:border-r border-white/10 p-8 md:p-16 flex flex-col justify-center gap-10 bg-[#030303]">
                  ...
                  <div className="p-8 bg-gradient-to-b from-emerald-500 to-emerald-600 border border-emerald-400 shadow-2xl rounded-sm relative group overflow-hidden transition-transform duration-300 hover:-translate-y-1 cursor-pointer">
                    <div className="relative z-10 flex flex-col gap-1">
                      ...
                      <h3 className="text-5xl font-medium text-emerald-950 tracking-tight mt-1">
                        0.02<span className="text-2xl ml-1">ms</span>
                      </h3>
                      <p className="text-xs text-emerald-900 mt-3 font-medium opacity-70">
                        Instant document processing achieved through our
                        optimized AI servers.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="p-8 bg-gradient-to-b from-white/[0.08] to-white/[0.02] border border-white/10 shadow-2xl rounded-sm group overflow-hidden transition-transform duration-300 hover:-translate-y-1 cursor-pointer">
                    <div className="relative z-10 flex flex-col gap-1">
                      ...
                      <h3 className="text-5xl font-medium text-white tracking-tight mt-1">
                        99.9<span className="text-2xl ml-1">%</span>
                      </h3>
                      <p className="text-xs text-gray-400 mt-3 font-normal opacity-70">
                        Verified study materials ensure you're always learning
                        the right stuff.
                      </p>
                    </div>
                  </div>
                    ...
                    >
                      {activePanel !== idx ? (
                        ...
                        <div className="p-8 md:p-12 h-full flex flex-col justify-between animate-in fade-in duration-700">
                          ...
                          <div>
                            <h4 className="text-4xl md:text-6xl font-medium tracking-tighter mb-4 leading-none">
                              {phase.title}
                            </h4>
                            <p className="text-sm md:text-base text-gray-700 font-normal max-w-md leading-relaxed">
                              {phase.desc}
                            </p>
                          </div>
                        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-12 mb-16 text-center">
              <h2 className="text-4xl md:text-7xl font-bold tracking-tighter text-white mb-6">
                Built for every{" "}
                <span className="text-emerald-500">University.</span>
              </h2>
              <p className="text-gray-500 max-w-2xl mx-auto text-lg italic">
                We've mapped academic content from over 50 leading institutions
                into a single, unified study archive.
              </p>
            </div>
                ...
                >
                  <div className="p-6 flex items-center justify-between">
                    <div className="flex flex-col">
                      ...
                      <h4 className="text-xl font-bold text-white mb-0.5">
                        {uni.name}
                      </h4>
                    </div>
            ...
            <div className="lg:col-span-8 h-[500px] relative rounded-3xl overflow-hidden border border-white/5 bg-[#0a0a0a]/50 p-12 group">
              ...
              <div className="relative z-10 h-full flex flex-col justify-center text-left">
                ...
                <h3 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-[1.1]">
                  The Network <br />
                  is expanding.
                </h3>
                <p className="text-gray-400 max-w-md text-lg leading-relaxed mb-10 italic">
                  Our global university network is expanding daily,
                  synchronizing millions of data points to provide the most
        ...
        <section className="py-20 px-6 w-full max-w-7xl relative z-10 border-t border-white/5">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/2">
              <div className="text-emerald-500 text-[10px] font-bold uppercase tracking-[0.3em] mb-4">
                Study Intelligence // Ver 2.0
              </div>
              <h2 className="text-4xl md:text-7xl font-bold text-white tracking-tighter mb-8 leading-none">
                Your AI <br />
                <span className="text-gray-700">Study Partner.</span>
              </h2>
              <p className="text-gray-400 text-lg leading-relaxed mb-12 italic max-w-md">
                Our intelligence engine doesn't just store files; it understands
                them. Get smart summaries, topic analysis, and predictive exam
                questions personalized for you.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="p-4 bg-white/[0.02] border border-white/5 rounded-2xl flex items-center gap-4 group hover:bg-white/[0.05] transition-colors cursor-pointer"
                  >
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-12">
          <div>
            ...
            <p className="text-gray-500 max-w-xs text-sm leading-relaxed">
              Simplifying academic success through verified study materials and
        ...
        <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] uppercase tracking-[0.2em] font-bold text-gray-600">
          ...
          <div className="flex gap-8">
            <span className="flex items-center gap-2">
              <div className="w-1 h-1 rounded-full bg-emerald-500"></div> System
              Latency: 12ms
            </span>
            <span className="flex items-center gap-2">
              <div className="w-1 h-1 rounded-full bg-emerald-500"></div> Nodes
              active: 4,281
            </span>
          </div>
        </div>
