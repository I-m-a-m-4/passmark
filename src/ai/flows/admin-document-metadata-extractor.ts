...
const AdminDocumentMetadataExtractorOutputSchema = z.object({
  university: z.string().describe('The name of the university found in the document.').default(''),
  department: z.string().describe('The name of the academic department found in the document.').default(''),
  courseCode: z.string().describe('The alphanumeric code for the course (e.g., "CSC101", "MTH203") found in the document.').default(''),
  year: z.string().describe('The academic year(s) or examination year(s) to which the past question paper belongs (e.g., "2023/2024", "2023", "2022-2023").').default(''),
});
