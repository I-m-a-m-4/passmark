...
export const AuraCard = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <div className={cn("flex flex-col z-10 bg-white/70 dark:bg-[#0a0a0a]/60 backdrop-blur-3xl border-black/5 dark:border-white/10 relative shadow-xl dark:shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden rounded-xl", className)}>
